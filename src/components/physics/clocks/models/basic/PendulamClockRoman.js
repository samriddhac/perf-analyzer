...
export default () => {
    ...
    const numArrays = ['XII', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI'];
    ...
    return (
        <div className='basic-pendulam-roman-container'>
            <div className='pendulam-roman-container'>
                <div className='basic-pendulam-roman'>
            ...
            <div className='bottom-section-roman'>
